...
TEST(AppTest, OpenLineStyleDxf) {
    // Ensure the result_image directory exists
    EnsureDirectoryExists("result_image");

    // Path to the DXF file
    std::string dxfFilePath = "../test/test_dxf/line_style.dxf";
    ...
    // Call the refactored function to draw and save the bitmap
    DrawAndSaveBitmap(page, 200, 200, "open_line_style_dxf");
...
TEST(AppTest, OpenLineWidthDxf) {
    // Ensure the result_image directory exists
    EnsureDirectoryExists("result_image");

    // Path to the DXF file
    std::string dxfFilePath = "../test/test_dxf/line_width.dxf";
    ...
    // Call the refactored function to draw and save the bitmap
    DrawAndSaveBitmap(page, 400, 400, "open_line_width_dxf");
